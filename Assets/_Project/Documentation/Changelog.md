...
- Continued gameplay after clear



Added ScoreManager

Added GameplayScoreUI

Added Placement Score

Added Line Clear Bonus

Added High Score Saving

Integrated SaveService

Verified Bootstrap-based save flow

Fixed occupied cell visual persistence bug
